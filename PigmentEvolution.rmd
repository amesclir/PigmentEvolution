...
lambda.Anthocyanins <- fitDiscrete(tree, Anthocyanins, model = "ER", transform = "lambda")
...
lambda.Aurones <- fitDiscrete(tree, Aurones, model = "ARD", transform = "lambda")
...
lambda.Carotenoids <- fitDiscrete(tree, Carotenoids, model = "ARD", transform = "lambda")
lambda.Carotenoids
...
lambda.Chlorophylls <- fitDiscrete(tree, Chlorophylls, model = "ARD", transform = "lambda")
lambda.Chlorophylls
...
lambda.NPigments <- fitDiscrete(tree, NPigments, model = "ARD", transform = "lambda")
