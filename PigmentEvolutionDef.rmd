...
pdf(file=pdffn, width=6, height=60)
plotRECON(tree,pp.Aurones.ARD.2$states,cex=0.5, pie.cex=0.5,title="Aurones 2 rates ER")
dev.off()
...
pdf(file=pdffn, width=6, height=60)
plotRECON(tree,pp.Carotenoids.ARD.2$states,cex=0.5, pie.cex=0.5,title="Carotenoids 2 rates ER")
dev.off()
...
pdf(file=pdffn, width=6, height=60)
plotRECON(tree,pp.Chlorophylls.ARD.2$states,cex=0.5, pie.cex=0.5,title="Chlorophylls 2 rates ER")
dev.off()
...
pp.Npigments.SYM.1
pp.Npigments.STEP.2<-corHMM(tree,Npigments,rate.cat=2, rate.mat=STEP, node.states="marginal")
pp.Npigments.STEP.2
...
simmap.Npigments <- makeSimmap(tree=tree, data=Npigments, model=pp.Npigments.ARD.2$solution, rate.cat=2, nSim=100, nCores=1)
summary(simmap.Npigments)

pdffn = paste0("Model.Npigments2rates.ARD.pdf")
pdf(file=pdffn, width=6, height=8)
plotMKmodel(pp.Npigments.ARD.2)
dev.off()

pdffn = paste0("Npigments2rates.ARD.pdf")
pdf(file=pdffn, width=6, height=60)
plotRECON(tree,pp.Npigments.ARD.2$states,cex=0.5, pie.cex=0.5,title="Npigments 2 rates ER")
dev.off()
