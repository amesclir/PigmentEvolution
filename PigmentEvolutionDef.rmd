...
cols<-setNames(c("grey", "orange", "grey", "orange"),levels(c("(0,R1)", "(1,R1)", "(0,R2)", "(1,R2)")))
...
cols<-setNames(c("pink", "pink", "brown", "brown"),levels(c("(0,R1)", "(1,R1)", "(0,R2)", "(1,R2)")))
...
cols<-setNames(c("grey", "grey", "grey", "grey", "orange", "orange", "orange", "orange"),levels(c("(0,R1)", "(1,R1)", "(2,R1)", "(3,R1)", "(0,R2)", "(1,R2)", "(2,R2)", "(3,R2)")))
...
cols<-setNames(c("yellow", "orange", "red", "darkred", "yellow", "orange", "red", "darkred"),levels(c("(0,R1)", "(1,R1)", "(2,R1)", "(3,R1)", "(0,R2)", "(1,R2)", "(2,R2)", "(3,R2)")))
...
#cols<-setNames(c("white","white","yellow", "yellow", "pink","pink","red", "red"),levels(c("(0_0,R1)", "(0_0,R2)", "(0_1,R1)", "(0_1,R2)", "(1_0,R1)", "(1_0,R2)", "(1_1,R1)", "(1_1,R2)")))
cols<-setNames(c("#FFFFFFE2","#FFFFFFE6","yellow1", "yellow2", "pink1","pink2","red1", "red2"),levels(c("(1,R1)", "(1,R2)", "(2,R1)", "(2,R2)", "(3,R1)", "(3,R2)", "(4,R1)", "(4,R2)")))
pdffn = paste0("Anthocyanins.Aurones2ratesfanARDy.color.pdf")
pdf(file=pdffn, width=27, height=27)
plot(tree,type="fan",cex=0.6,font=3,lwd=1)
nodelabels(node=1:tree$Nnode+Ntip(tree),
    pie=pp.Anthocyanins.Aurones.ARDy.2$states,piecol=cols,cex=0.2)
...
cols<-setNames(c("#FFFFFFE2","grey1","#FFFFFFE6","grey2","#FFFFFFCC","grey3","#FFFFFF99","grey4"),levels(c("(0_0,R1)", "(0_0,R2)", "(0_1,R1)", "(0_1,R2)", "(1_0,R1)", "(1_0,R2)", "(1_1,R1)", "(1_1,R2)")))
pdffn = paste0("Anthocyanins.Aurones2ratesfanARDy.regimes.pdf")
pdf(file=pdffn, width=27, height=27)
plot(tree,type="fan",cex=0.6,font=3,lwd=1)
nodelabels(node=1:tree$Nnode+Ntip(tree),
    pie=pp.Anthocyanins.Aurones.ARDy.2$states,piecol=cols,cex=0.2)
...
simmap.Aurones.Chlorophylls2 <- makeSimmap(tree=tree, data=Aurones.Chlorophylls, model=pp.Aurones.Chlorophylls.ARDxy.2$solution, rate.cat=2, nSim=100, nCores=1)
summary(simmap.Aurones.Chlorophylls2)
