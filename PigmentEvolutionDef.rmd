...
simmap.Carotenoids.Aurones <- makeSimmap(tree=tree, data=Carotenoids.Aurones, model=pp.Carotenoids.Aurones.ARDy.2$solution, rate.cat=2, nSim=100, nCores=1)
summary(simmap.Carotenoids.Aurones)

pdffn = paste0("Model.Carotenoids.Aurones2rates.ARDy.pdf")
pdf(file=pdffn, width=6, height=8)
plotMKmodel(pp.Carotenoids.Aurones.ARDy.2)
dev.off()

pdffn = paste0("Carotenoids.Aurones2rates.ARDy.pdf")
pdf(file=pdffn, width=6, height=60)
plotRECON(tree,pp.Carotenoids.Aurones.ARDy.2$states,cex=0.5, pie.cex=0.5,title="Carotenoids.Aurones 2 rates ARDy")
dev.off()

cols<-setNames(c("white","lightgrey","darkgrey", "black", "red","darkorange","orange", "yellow"),levels(c("(0_0,R1)", "(0_0,R2)", "(0_1,R1)", "(0_1,R2)", "(1_0,R1)", "(1_0,R2)", "(1_1,R1)", "(1_1,R2)")))
pdffn = paste0("Carotenoids.Aurones2ratesfanARDy.pdf")
pdf(file=pdffn, width=27, height=27)
plot(tree,type="fan",cex=0.6,font=3,lwd=1)
nodelabels(node=1:tree$Nnode+Ntip(tree),
    pie=pp.Carotenoids.Aurones.ARDy.2$states,piecol=cols,cex=0.2)
dev.off()
