...
cols<-setNames(c("white","white","yellow", "yellow", "pink","pink","red", "red"),levels(c("(1,R1)", "(1,R2)", "(2,R1)", "(2,R2)", "(3,R1)", "(3,R2)", "(4,R1)", "(4,R2)")))
...
cols<-setNames(c("white","grey","white","grey","white","grey","white","grey"),levels(c("(0_0,R1)", "(0_0,R2)", "(0_1,R1)", "(0_1,R2)", "(1_0,R1)", "(1_0,R2)", "(1_1,R1)", "(1_1,R2)")))
