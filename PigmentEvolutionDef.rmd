...
cols<-setNames(c("grey", "grey", "grey", "grey", "orange", "orange", "orange", "orange"),levels(c("(1,R1)", "(2,R1)", "(3,R1)", "(4,R1)", "(1,R2)", "(2,R2)", "(3,R2)", "(4,R2)")))
...
cols<-setNames(c("grey", "grey", "grey", "grey", "orange", "orange", "orange", "orange"),(c("(0,R1)", "(1,R1)", "(2,R1)", "(3,R1)", "(0,R2)", "(1,R2)", "(2,R2)", "(3,R2)")))
...
cols<-setNames(c("white","yellow","pink", "red", "white","yellow","pink", "red"),levels(c("(1,R1)", "(2,R1)", "(3,R1)", "(4,R1)", "(1,R2)", "(2,R2)", "(3,R2)", "(4,R2)")))
pdffn = paste0("Carotenoids.Aurones2ratesfanIND.color.pdf")
pdf(file=pdffn, width=27, height=27)
plot(tree,type="fan",cex=0.6,font=3,lwd=1)
nodelabels(node=1:tree$Nnode+Ntip(tree),
    pie=pp.Carotenoids.Aurones.IND.2$states,piecol=cols,cex=0.2)
...
cols<-setNames(c("white","white","white", "white", "grey","grey","grey", "grey"),levels(c("(1,R1)", "(2,R1)", "(3,R1)", "(4,R1)", "(1,R2)", "(2,R2)", "(3,R2)", "(4,R2)")))
pdffn = paste0("Carotenoids.Aurones2ratesfanIND.rates.pdf")
pdf(file=pdffn, width=27, height=27)
plot(tree,type="fan",cex=0.6,font=3,lwd=1)
nodelabels(node=1:tree$Nnode+Ntip(tree),
    pie=pp.Carotenoids.Aurones.IND.2$states,piecol=cols,cex=0.2)
