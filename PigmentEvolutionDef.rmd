...
cols<-setNames(c("white","lightgrey","#666666","black"),levels(as.factor(vvNPigments)))
colsnode<-setNames(c("white","white","lightgrey","lightgrey","#666666","#666666","black","black"),c("(0,R1)", "(0,R2)", "(1,R1)", "(1,R2)", "(2,R1)", "(2,R2)", "(3,R1)", "(3,R2)"))
...
colsrates<-setNames(c("green","red","green","red","green","red","green","red"),c("(0,R1)", "(0,R2)", "(1,R1)", "(1,R2)", "(2,R1)", "(2,R2)", "(3,R1)", "(3,R2)"))
cols5<-setNames(c("lightyellow","lightgrey"),levels(as.factor(vvFlavonoids)))
cols2<-setNames(c("#e32be3","lightgrey"),levels(as.factor(vvAnthocyanins)))
cols3<-setNames(c("#fa8c00","lightgrey"),levels(as.factor(vvCarotenoids)))
cols4<-setNames(c("#ffe400","lightgrey"),levels(as.factor(vvAurones)))
