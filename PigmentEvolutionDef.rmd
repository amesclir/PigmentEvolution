...
colsnode<-setNames(c("white","white","lightgrey","lightgrey","#555555","#555555","black","black"),c("(0,R1)", "(0,R2)", "(1,R1)", "(1,R2)", "(2,R1)", "(2,R2)", "(3,R1)", "(3,R2)"))
...
arc.cladelabels(tree, "Solanaceae", node6, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=0.9,orientation="curved", stretch=1)
...
arc.cladelabels(tree, "Malvaceae", node10, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
...
arc.cladelabels(tree, "Melastomataceae", node16, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1.5,orientation="curved", stretch=1)
...
arc.cladelabels(tree, "Xyridaceae", node22, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=0.7,orientation="curved", stretch=1)
arc.cladelabels(tree, "Aristolochiaceae", node35, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=0.7,orientation="curved", stretch=1)
arc.cladelabels(tree, "Magnoliaceae", node36, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=0.7,orientation="curved", stretch=1)
arc.cladelabels(tree, "Liliaceae", node37, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
arc.cladelabels(tree, "Apiaceae", node38, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
arc.cladelabels(tree, "Phyrmaceae", node39, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
arc.cladelabels(tree, "Ericaceae", node40, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
...
arc.cladelabels(tree, "Convolvulaceae", node42, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=0.9,orientation="curved", stretch=1)
arc.cladelabels(tree, "Cistaceae", node43, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
arc.cladelabels(tree, "Ranunculaceae", node44, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
dev.off()
...
add.simmap.legend(colors=cols4,prompt=FALSE,x=0.7*par()$usr[1],
    y=0.9*par()$usr[3],fsize=2)
arc.cladelabels(tree, "Magnolids", node24, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=1,orientation="curved", stretch=1)
arc.cladelabels(tree, "Monocots", node25, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=2,orientation="curved", stretch=1)
...
arc.cladelabels(tree, "Lamiids", node29, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=2,orientation="curved", stretch=1)
arc.cladelabels(tree, "Campanulids", node30, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=2,orientation="curved", stretch=1)
...
arc.cladelabels(tree, "Fabids", node33, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=2,orientation="curved", stretch=1)
arc.cladelabels(tree, "Malvids", node34, ln.offset=1.1, lab.offset=1.12,mark.node=FALSE, cex=2,orientation="curved", stretch=1)
dev.off()
```
