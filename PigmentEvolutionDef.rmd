...
cols<-setNames(c("lightyellow","#e32be3"),levels(as.factor(vAnthocyanins)))
cols
colsnode<-setNames(c("lightyellow", "lightyellow","#e32be3","#e32be3"),c("(0,R1)", "(0,R2)", "(1,R1)", "(1,R2)"))
colsnode
...
add.simmap.legend(colors=cols5,prompt=FALSE,x=0.9*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
tiplabels(pie=to.matrix(vAnthocyanins[tree$tip.label],
    levels(as.factor(vAnthocyanins))),piecol=cols2b, bg=cols2b,cex=0.1, offset = 4)
add.simmap.legend(colors=cols2b,prompt=FALSE,x=0.8*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
tiplabels(pie=to.matrix(vvCarotenoids[tree$tip.label],
    levels(as.factor(vvCarotenoids))),piecol=cols3, bg=cols3,cex=0.1, offset = 5.5)
add.simmap.legend(colors=cols3,prompt=FALSE,x=0.7*par()$usr[1],
...
cols<-setNames(c("lightyellow","#fa8c00"),levels(as.factor(vCarotenoids)))
colsnode<-setNames(c("lightyellow", "lightyellow","#fa8c00","#fa8c00"),c("(0,R1)", "(0,R2)", "(1,R1)", "(1,R2)"))
...
add.simmap.legend(colors=cols2,prompt=FALSE,x=0.8*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
tiplabels(pie=to.matrix(vCarotenoids[tree$tip.label],
    levels(as.factor(vCarotenoids))),piecol=cols3b, bg=cols3b,cex=0.1, offset = 5.5)
add.simmap.legend(colors=cols3b,prompt=FALSE,x=0.7*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
tiplabels(pie=to.matrix(vvChlorophylls[tree$tip.label],
    levels(as.factor(vvChlorophylls))),piecol=cols6, bg=cols6,cex=0.1, offset = 7)
add.simmap.legend(colors=cols6,prompt=FALSE,x=0.8*par()$usr[1],
...
add.simmap.legend(colors=cols2,prompt=FALSE,x=0.8*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
tiplabels(pie=to.matrix(vCarotenoids[tree$tip.label],
    levels(as.factor(vCarotenoids))),piecol=cols3b, bg=cols3,cex=0.1, offset = 5.5)
add.simmap.legend(colors=cols3b,prompt=FALSE,x=0.7*par()$usr[1],
    y=0.8*par()$usr[3],fsize=2)
tiplabels(pie=to.matrix(vvChlorophylls[tree$tip.label],
    levels(as.factor(vvChlorophylls))),piecol=cols6, bg=cols6,cex=0.1, offset = 7)
